...
import com.election.voting.president.persistence.entities.Issue;
...
import com.election.voting.president.persistence.repositories.VoterRepository;
...
public class VoteServiceImpl implements VoteService {
    ...
    @Autowired
    public VoteServiceImpl(VoteRepository voteRepository, CandidateRepository candidateRepository, VoterRepository voterRepository) {
    ...
    public Map<String, Map<Candidate, Long>> getVotesPerRegion() {
        return getVotes().collect(groupingBy(vote -> vote.getVoter().getRegion().getLabel(), groupingBy(Vote::getCandidate, counting())));
    }
